    ...
    public function run(): void
    {
        $batulao = Mountain::query()->updateOrCreate(
            ...
            [
                ...
                'jumpoff_name' => 'Brgy. Kayrilaw Jump-off',
                'jumpoff_address' => 'Brgy. Kayrilaw, Nasugbu, Batangas',
                'jumpoff_meeting_time' => '5:00 AM',
                'jumpoff_notes' => 'Register at the barangay hall. Entrance fee: PHP 50. Parking available near the registration area. Restrooms available at the base.',
                'jumpoff_lat' => 14.0500,
                'jumpoff_lng' => 120.6510,
                'summit_lat' => 14.0430,
                'summit_lng' => 120.6360,
                'open_meteo_lat' => 14.0667,
                'open_meteo_lng' => 120.6333,
        ...
        $pico = Mountain::query()->updateOrCreate(
            ...
            [
                ...
                'jumpoff_name' => 'DENR Office, Ternate',
                'jumpoff_address' => 'DENR Ternate, Ternate, Cavite',
                'jumpoff_meeting_time' => '5:30 AM',
                'jumpoff_notes' => 'DENR registration is mandatory. Bring a valid ID. A local guide is required for all hikers. Prepare exact change for registration fees.',
                'jumpoff_lat' => 14.2875,
                'jumpoff_lng' => 120.7150,
                'summit_lat' => 14.2520,
                'summit_lng' => 120.6540,
        ...
        $talamitam = Mountain::query()->updateOrCreate(
            ...
            [
                ...
                'jumpoff_name' => 'Sitio Bayabasan Jump-off',
                'jumpoff_address' => 'Sitio Bayabasan, Nasugbu, Batangas',
                'jumpoff_meeting_time' => '5:00 AM',
                'jumpoff_notes' => 'Register at the base. Small entrance fee of PHP 30. Limited parking available. Sari-sari store nearby for last-minute supplies.',
                'jumpoff_lat' => 14.0700,
                'jumpoff_lng' => 120.6400,
                'summit_lat' => 14.0615,
                'summit_lng' => 120.6340,
