...
<div class="ns-booking-feedback" data-booking-feedback="{{ $booking->id }}">
    <div class="ns-completed-feedback-grid">
        <article class="ns-feedback-panel" data-feedback-panel="mountain" data-booking-id="{{ $booking->id }}">
            <details class="ns-feedback-dropdown" data-feedback-dropdown>
                <summary class="ns-feedback-summary">
                    ...
                    <span class="ns-feedback-caret" aria-hidden="true">▾</span>
                </summary>

                <div class="ns-feedback-body">
                    <p class="ns-feedback-desc">Share trail conditions, pacing, and what future hikers should expect from this route.</p>
        ...
        <article class="ns-feedback-panel" data-feedback-panel="guide" data-booking-id="{{ $booking->id }}">
            <details class="ns-feedback-dropdown" data-feedback-dropdown>
                ...
                <div class="ns-feedback-body">
                    <p class="ns-feedback-desc">Leave feedback about communication, pacing, trail support, and the overall guiding experience.</p>
